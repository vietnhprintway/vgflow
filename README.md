...
**Version:** 2.12.2 · **License:** MIT

**Latest (v2.12.2):** `/vg:review` now requires concrete CrossAI evidence when configured, and `--skip-crossai` must leave override debt instead of silently downgrading objective review.
