...
**Version:** 2.40.0 · **License:** MIT

**v2.40.0 (2026-04-30):** Recursive Lens Probe — exploratory deep-scan with 16 bug-class lenses, 3 probe modes (auto/manual/hybrid), multi-phase `/vg:review-batch`, sandbox env policy. See [CHANGELOG](CHANGELOG.md#v2400).
