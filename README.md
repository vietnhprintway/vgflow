...
**Version:** 2.5.2.4 · **License:** MIT

**Latest (v2.3.1):** Level 5 autonomous workflow engineering — 3 remaining gaps closed (dead scripts wired, codex drift loop fixed, bootstrap self-learning feedback functional). 77/77 targeted tests. See [CHANGELOG](CHANGELOG.md#231---2026-04-23) for details.
...
The installer copies commands, skills, scripts (including `validators/` + `vg-orchestrator/` + `tests/` subdirectories), templates, and generates `.claude/vg.config.md` from the template. Codex + Gemini CLI skills are deployed to `.codex/skills/` and `~/.codex/skills/` (global) when detected.
