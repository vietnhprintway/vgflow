...
**Version:** 2.12.6 · **License:** MIT

**Latest (v2.12.6):** build now injects per-task context capsules, and blueprint adds an independent Codex TEST-GOALS proposal/delta lane before final review.
