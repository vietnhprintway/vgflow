...
**Version:** 2.12.1 · **License:** MIT

**Latest (v2.12.1):** `/vg:build` now separates code execution from formal build completion: CrossAI build verification and `run-complete` must pass before `build.completed` and build=done state are emitted.
