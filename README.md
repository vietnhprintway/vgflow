...
**Version:** 2.87.0 · **License:** MIT

**v2.87.0 (2026-05-10):** v3.0.0 prep nearly complete. `vg-migrate-v3.sh` chains `merge-deploy-states.py` automatically. v3.0.0 ship blocked on `/vg:update` global-aware refactor (Stage 9 final).

**v2.86.0 (2026-05-10):** Tier 1 docs from [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) audit — anti-rationalization tables + engineering principles + lifecycle taxonomy + skill discovery flowchart. See [CHANGELOG](CHANGELOG.md).
